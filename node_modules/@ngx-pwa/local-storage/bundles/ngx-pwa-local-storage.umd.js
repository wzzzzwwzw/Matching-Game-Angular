(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['ngx-pwa'] = global['ngx-pwa'] || {}, global['ngx-pwa']['local-storage'] = {}), global.ng.core, global.ng.common, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var JSONValidator = /** @class */ (function () {
        ...
        JSONValidator.prototype.validateObject = function (data, schema) {
            ...
            if (schema.required) {
                try {
                    for (var _c = __values(schema.required), _d = _c.next(); !_d.done; _d = _c.next()) {
                        var requiredProp = _d.value;
     ...
     */
    var LS_PREFIX = new i0.InjectionToken('localStoragePrefix', {
        providedIn: 'root',
     ...
     */
    var IDB_DB_NAME = new i0.InjectionToken('localStorageIDBDBName', {
        providedIn: 'root',
     ...
     */
    var IDB_DB_VERSION = new i0.InjectionToken('localStorageIDBDBVersion', {
        providedIn: 'root',
     ...
     */
    var IDB_STORE_NAME = new i0.InjectionToken('localStorageIDBStoreName', {
        providedIn: 'root',
     ...
     */
    var IDB_NO_WRAP = new i0.InjectionToken('localStorageIDBWrap', {
        providedIn: 'root',
    ...
    var IndexedDBDatabase = /** @class */ (function () {
        ...
        IndexedDBDatabase.prototype.set = function (key, data) {
            ...
            return this.transaction('readwrite').pipe(operators.mergeMap(function (transactionData) {
                ...
                var dataToStore = _this.noWrap ? data : (_b = {}, _b[_this.wrapIndex] = data, _b);
        ...
        IndexedDBDatabase.prototype.listenError = function (transactionOrRequest) {
            ...
            operators.mergeMap(function (event) { return rxjs.throwError(event.target.error); }));
        };
        /**
         * Listen transaction `complete` and `error` events
    ...
    IndexedDBDatabase.ɵprov = i0.ɵɵdefineInjectable({ factory: function IndexedDBDatabase_Factory() { return new IndexedDBDatabase(i0.ɵɵinject(IDB_DB_NAME), i0.ɵɵinject(IDB_STORE_NAME), i0.ɵɵinject(IDB_DB_VERSION), i0.ɵɵinject(IDB_NO_WRAP)); }, token: IndexedDBDatabase, providedIn: "root" });
    ...
    IndexedDBDatabase.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: i0.Inject, args: [IDB_DB_NAME,] }] },
        { type: undefined, decorators: [{ type: i0.Inject, args: [IDB_STORE_NAME,] }] },
        { type: undefined, decorators: [{ type: i0.Inject, args: [IDB_DB_VERSION,] }] },
        { type: undefined, decorators: [{ type: i0.Inject, args: [IDB_NO_WRAP,] }] }
    ]; };
    ...
    LocalStorageDatabase.ɵprov = i0.ɵɵdefineInjectable({ factory: function LocalStorageDatabase_Factory() { return new LocalStorageDatabase(i0.ɵɵinject(LS_PREFIX)); }, token: LocalStorageDatabase, providedIn: "root" });
    ...
    LocalStorageDatabase.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: i0.Inject, args: [LS_PREFIX,] }] }
    ]; };
    ...
    var MemoryDatabase = /** @class */ (function () {
        ...
        MemoryDatabase.prototype.get = function (key) {
            /* Wrap in a RxJS `Observable` to be consistent with other storages */
            return rxjs.of(this.memoryStorage.get(key));
        };
        /**
    ...
    LocalDatabase.ɵprov = i0.ɵɵdefineInjectable({ factory: function LocalDatabase_Factory() { return localDatabaseFactory(i0.ɵɵinject(i0.PLATFORM_ID), i0.ɵɵinject(LS_PREFIX), i0.ɵɵinject(IDB_DB_NAME), i0.ɵɵinject(IDB_STORE_NAME), i0.ɵɵinject(IDB_DB_VERSION), i0.ɵɵinject(IDB_NO_WRAP)); }, token: LocalDatabase, providedIn: "root" });
    ...
    var StorageMap = /** @class */ (function () {
        ...
        StorageMap.prototype.clear = function () {
            ...
            operators.tap(function () {
                var e_1, _b;
                try {
                    for (var _c = __values(_this.notifiers.keys()), _d = _c.next(); !_d.done; _d = _c.next()) {
                        var key = _d.value;
        ...
        StorageMap.prototype.watch = function (key, schema) {
            ...
            if (!this.notifiers.has(key)) {
                this.notifiers.set(key, new rxjs.ReplaySubject(1));
            }
    ...
    StorageMap.ɵprov = i0.ɵɵdefineInjectable({ factory: function StorageMap_Factory() { return new StorageMap(i0.ɵɵinject(LocalDatabase), i0.ɵɵinject(JSONValidator), i0.ɵɵinject(LS_PREFIX)); }, token: StorageMap, providedIn: "root" });
    ...
    LocalStorage.ɵprov = i0.ɵɵdefineInjectable({ factory: function LocalStorage_Factory() { return new LocalStorage(i0.ɵɵinject(StorageMap)); }, token: LocalStorage, providedIn: "root" });
    ...
    exports.ɵb = LS_PREFIX;
    exports.ɵc = IDB_DB_NAME;
    exports.ɵd = IDB_DB_VERSION;
    exports.ɵe = IDB_STORE_NAME;
    exports.ɵf = IDB_NO_WRAP;
